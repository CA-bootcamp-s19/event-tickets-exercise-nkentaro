...
contract EventTicketsV2 {
    ...
    */
    ...
    // function getBuyerNumberTickets(uint eventId, address ticketHolder)
    //     public
    //     view
    //     returns(uint ticketCount)
    // {
    //     ticketCount = events[eventId].buyers[ticketHolder];
    // }
    ...
    */
        ...
        payable
    {
        ...
        uint price = PRICE_TICKET * numTickets;
    ...
    */
        ...
        onlyOwner(msg.sender)
    {
        ...
        uint balanceTransferred = PRICE_TICKET * events[eventId].sales;
